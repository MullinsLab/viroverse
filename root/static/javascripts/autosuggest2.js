 ...
 * @scope public
 */
function AutoSuggestControl(oTextbox /*:HTMLInputElement*/, oProvider /*:SuggestionProvider*/, callback) {
    ...
    // function to call when option is chosen
...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.setAttribute("onkeypress", "return noenter();");
    
    //when the user clicks on the a suggestion, get the text (innerHTML)
    //and place it into a textbox
    this.layer.onkeypress = 
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
                ...
                // there may be a span around the text
 ...
 */
AutoSuggestControl.prototype.handleKeyUp = function (oEvent /*:Event*/, callback) {
...
AutoSuggestControl.prototype.init = function () {
    ...
    this.textbox.onkeyup = function (oEvent) {
        ...
        oThis.handleKeyUp(oEvent,oThis.callback);
    };
...
AutoSuggestControl.prototype.showSuggestions = function (aSuggestions /*:Array*/) {
    var listSize = aSuggestions.length;
    var oDiv = null;
...
//    for (var i in aSuggestions) {
    ...
    this.layer.style.backgroundColor= "#FFFFCC";
    if (listSize > 8) {
        this.layer.style.height = 10 + "em";
    }else {
